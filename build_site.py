...
.js .map .pin{animation:pinDrop .5s backwards;animation-delay:calc(.08s * var(--i,0))}
...
(function(){
  ...
  document.querySelectorAll(sel).forEach(function(el){
    ...
    var g=el.parentElement; groups[g]=groups[g]||0; el.style.setProperty("--i",groups[g]++); el.classList.add("rv");
  });
